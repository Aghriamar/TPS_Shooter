...
class TPS_SHOOTER_API UTPSInventoryComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:	
	...
	UFUNCTION(Server, Reliable, BlueprintCallable, Category = "Inv")
		...
		void InitInventory_OnServer_Implementation(const TArray<FWeaponSlot>& NewWeaponSlotsInfo, const TArray<FAmmoSlot>& NewAmmoSlotsInfo);
};
